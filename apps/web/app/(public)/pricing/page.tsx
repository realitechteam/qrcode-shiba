...
const plans = [
    {
        ...
        popular: false,
        features: [
            { name: "Không giới hạn QR tĩnh", included: true },
            { name: "Đếm lượt quét cơ bản", included: true },
            { name: "Tùy chỉnh màu sắc", included: true },
            { name: "Xuất PNG", included: true },
            { name: "QR Dynamic", included: false },
            { name: "Analytics chi tiết", included: false },
    ...
    },
    {
        ...
        features: [
            ...
            { name: "QR Dynamic - thay đổi URL", included: true },
            { name: "Analytics chi tiết", included: true },
            { name: "Xuất PNG, SVG, PDF", included: true },
            { name: "Tùy chỉnh logo", included: true },
