...
import { z } from "zod";
import { QrCode, Loader2, Mail, CheckCircle2, ArrowRight } from "lucide-react";
...
export default function RegisterPage() {
    ...
    const { requestMagicLink, isLoading } = useAuthStore();
                    ...
                    <div className="bg-card rounded-2xl border p-8 shadow-lg">
                        <div className="mb-6">
                            ...
                            <p className="text-muted-foreground mt-1">
                                Nhập email để bắt đầu miễn phí
                            </p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                            ...
                            <Button
                                type="submit"
                                className="w-full h-11 bg-shiba-500 hover:bg-shiba-600 text-base"
                                disabled={isLoading}
                            >
                                {isLoading ? (
                                    <>
                        ...
                        <div className="mt-6">
                            ...
                            <div className="mt-6 grid grid-cols-2 gap-3">
                                <Button variant="outline" className="w-full" onClick={() => window.location.href = "http://localhost:3001/auth/google"}>
